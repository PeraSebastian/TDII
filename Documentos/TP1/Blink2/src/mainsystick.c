...
#define GPIOA_ODR   *(volatile uint32_t *)(GPIOB_BASE + 0x0C)
...
void main(void) {
    // 1. Habilitar relojes para Puerto A y C
    ...
    // 3. Configurar PA0 como salida (LED externo)
    GPIOB_CRH &= 0xFF0FFFFF; // Limpiar bits del pin 0
